...
generator_agent = Agent(
    ...
    instruction="""Eres un abogado, tu tarea es generar un resumen breve, también llamado copete, que describa con claridad y precisión el contenido principal del documento legal, mencionando también la promulgación y adaptándose a ella. 
        ...
        [Output]
        Siempre poner la Ley y su número correspondiente al principio.
        ...
        Suele suceder que el documento no posee con claridad el texto de la ley, te daré algunos.
...
critic_agent_in_loop = Agent(
    ...
    Eres un abogado revisando el copete que otro abogado compañero tuyo realizó. Tu tarea es generar feedback para la
    mejora de ese copete.
    ...
    **Tarea:**
    ...
    1) Que el copete contenga al principio la Ley de la cual se está documentando
    ...
    [Ejemplos]
    Aquí tendrás un conjunto medianamente extenso de ejemplos para los cuales podrás compara estructura y forma de escritura con el prompt generado por el generador o el mejorador.
